  ...
  return (
    ...
    >
      <div className="w-full flex flex-col justify-between max-lg:text-center">
        <div className="flex-wrap pt-13 me-31.5 w-full lg:w-auto transition-all duration-500">
          <p className="text-3xl xxs:text-4xl sm:max-xl:text-5xl xl:text-6xl font-semibold w-full">
            Hello, I’m
            <span className="text-wrap md:text-nowrap shrink-0 inline-block w-full">
              Abegail Isidro - Sieffers
            </span>
          </p>
          <p className="xxs:text-lg lg:text-xl my-6 xs:bg-[#15182e] xs:p-5 md:p-0 md:bg-transparent rounded">
